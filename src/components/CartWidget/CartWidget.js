...
const CartWidget = () => {  
    ...
    const {cartListItems, removeProduct, clearCart, getAmountOfProducts} = useContext(CartContext);

    //traigo cantidad de productos en el carrito para que este en el navbar
